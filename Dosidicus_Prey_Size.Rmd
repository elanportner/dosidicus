...
###### Qualitative percent volume
```{r, echo = FALSE,  warning=FALSE, message = FALSE}

# comparing qualitative percent volume of prey groups between years
dietp <- ggplot(squidvlsum, aes(capture_year, prop, fill = Group))+geom_bar(stat="identity")+scale_fill_brewer(palette = "RdBu")+theme_dark()+theme(text=element_text(size=18))+xlab("Year")+ylab("Proportional Volume")
dietp
```
...
diet <- ggplot(preylsum, aes(capture_year, prop, fill = Group))+geom_bar(stat="identity")+scale_fill_manual(values=coul3)+theme_dark()+theme(text=element_text(size=18))+xlab("Year")+ylab("Numerical Proportion")
diet
...
dietp <- ggplot(squidvl_modsum, aes(capture_year, prop, fill = Group))+geom_bar(stat="identity")+scale_fill_brewer(palette = "RdBu")+theme_dark()+theme(text=element_text(size=18))+xlab("Year")+ylab("Proportional Volume")
dietp
...
diet <- ggplot(preyl_modsum, aes(capture_year, prop, fill = Group))+geom_bar(stat="identity")+scale_fill_manual(values=coul4)+theme_dark()+theme(text=element_text(size=18))+xlab("Year")+ylab("Numerical Proportion")
diet
```
...
histo1 <- histo1 + xlab("Mantle Length (cm)")+ scale_fill_manual(values = coul)+ggtitle("Dosidicus collected from the GOC 1996 - 2017")+theme_dark()+theme(text=element_text(size=18))+xlab("Mantle Length (cm)")+ylab("Number of Stomachs")
histo1
...
histo1 <- histo1 + xlab("Mantle Length (cm)")+ scale_fill_manual(values = coul)+ scale_color_manual(values = coul)+ggtitle("Dosidicus collected from the GOC 1996 - 2017")+theme_dark()
histo1
...
# comparing qualitative percent number of prey between years
preylsum$Group <- as.factor(preylsum$Group)
diet <- ggplot(squidlsum, aes(capture_year, prop, fill = Group))+geom_bar(stat="identity")+scale_fill_manual(values=coul3)+theme_dark()+theme(text=element_text(size=18))+xlab("Year")+ylab("Numerical Proportion")
diet
```
...
relat <- relat + xlab("Mantle Length (cm)")+ylab("Pterygiotuethis ML (mm)")+ scale_color_manual(values = coul)+ggtitle("Cephalopod prey size")+theme_dark()
relat
```
...
relat <- relat + xlab("Mantle Length (cm)")+ylab("Standard length (mm)")+ scale_color_manual(values = coul)+ggtitle("Fish prey size")+theme_dark()
relat
...
histo1 <- histo1 + xlab("Mantle Length (cm)")+ scale_fill_brewer(palette = "RdBu")+ggtitle("Dosidicus collected GOC summer 1996 - 2017")+theme_dark()+theme(text=element_text(size=18))+xlab("Mantle Length (cm)")+ylab("Number of Stomachs")
histo1
...
diet <- ggplot(summerlsum, aes(capture_year, prop, fill = Group))+geom_bar(stat="identity")+scale_fill_manual(values=coul3)+theme_dark()+theme(text=element_text(size=16))+xlab("Year")+ylab("Numerical Proportion")
diet
```
...
relat <- relat + xlab("Mantle Length (cm)")+ylab("Pterygiotuethis ML (mm)")+ scale_color_brewer(palette = "RdBu")+ggtitle("Cephalopod prey size")+theme_dark()+theme(text=element_text(size=18))
relat
...
relat1.2 <- relat1.2 + xlab("Mantle Length (cm)")+ylab("Standard Length (mm)")+ scale_color_brewer(palette = "RdBu")+ggtitle("Fish prey size")+theme_dark()
relat1.2
